  ...
  return (
    <div className="space-y-6">
            ...
            <tbody>
              {users.length === 0 ? (
                ...
                users.map((user, index) => (
                  <tr key={`${user.uid}-${index}`} className="border-b border-gray-100 hover:bg-gray-50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card card-sm">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Representative Invitations</h2>
          
          {/* Add New Representative Form */}
          <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
            <h3 className="text-lg font-medium text-gray-800 mb-3">Add New Representative</h3>
              ...
              <tbody>
                {representatives.length === 0 ? (
                  ...
                  representatives.map((rep, index) => (
                    <tr key={`${rep.uid}-${index}`} className="border-b border-gray-100 hover:bg-gray-50">
        ...
        <div className="card card-sm">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Admin Invitations</h2>
          
          {/* Add New Admin Form */}
          <div className="mb-6 p-4 bg-purple-50 rounded-lg border border-purple-200">
            <h3 className="text-lg font-medium text-gray-800 mb-3">Add New Admin</h3>
              ...
              <tbody>
                {admins.length === 0 ? (
                  ...
                  admins.map((admin, index) => (
                    <tr key={`${admin.uid}-${index}`} className="border-b border-gray-100 hover:bg-gray-50">
